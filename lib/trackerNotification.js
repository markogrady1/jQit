...
trackerNotif.getUserDetails = function() {
    ...
    notificationModel.getAllUsers((userData) => {
        async.each(userData, function (item, callback) {
            ...
            notificationModel.getRepositoryEmailNotifs(username, email, (userEmailNotifs) => {
               notificationModel.getTeamEmailNotifs(username, email, (teamEmailNotifs) => {
                   notificationModel.getContentEmailNotifs(username, email, (contentEmailNotifs) => {
...
transporter.sendMail(mailOptions, function(error, info){
    ...
    hist = require("../models/repoMigrate")
    hist.openIssuesMigrate();
    hist.pullsMigrate();
