...
resolve.resolveIssueData = function(param, req, res) {
	...
	console.log(allRepoHistory)
	schema.getAllHistory('repoPullsHistory', schema.completeDoc, function(completePulls){
		allRepoPullsHistory = completePulls;
	});
// console.log(allRepoPullsHistory)
