...
resolve.resolveIssueData = function(param, req, res) {
	...
	allRepoPullsHistory = [];
	var min, newRange;
	var fullDateRaw = [],createAtSeconds =[], pullRaw = [], newIssueUrl = null, oldIssueUrl = null, repoHistory = [],repoPullHistory = [], issueNumbers = [], pullNumbers = [], json = [], jsonPull = [];
 ...
 * @param {Function} fn
 */
var getIssueRangeURL = function(createAtSeconds, issDoc, isNewest, fn) {
	if(isNewest) {
